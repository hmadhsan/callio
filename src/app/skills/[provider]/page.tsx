...
export default async function SkillsProviderPage({ params }: { params: ProviderParams | Promise<ProviderParams> }) {
    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="border-b border-gray-200 bg-gradient-to-b from-blue-50/40 to-transparent py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl sm:text-5xl font-bold mb-4">Callio Skills</h1>
